...
public class EnergyGunBehaviour : MonoBehaviour {
	...
	void updateMaxRotations(){
		...
		maxLeftRotation.z = returnFixedAngle (mountedShip.transform.rotation.eulerAngles.z, 8f,true);
		maxRightRotation.z = returnFixedAngle (mountedShip.transform.rotation.eulerAngles.z, 14f, false);
